...
export function ProposeMovieDialog({ open, onOpenChange, initialMovieTitle = "" }: ProposeMovieDialogProps) {
  ...
  // Update the form when initialMovieTitle changes
  useEffect(() => {
    if (initialMovieTitle) {
      form.setValue("title", initialMovieTitle);
    }
  }, [initialMovieTitle, form]);
